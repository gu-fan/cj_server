...
var time = mmt("2018-11-10T00:00:00+08:00")
  ...
  return Promise.all([
    ...
    .then(function () {
      return knex('user').insert([
        ...
        {id:6, wx_id:'wx_z90fe01091304', name:'傻瓜这是装',created_at:times[6].format(), avatar:'/static/wx_avatar/6.jpg', total_answer_zhichi: 3,},
        {id:7, wx_id:'wx_kgjrgif0e9fua', name:'Angel、浮熙', created_at:times[7].format(),avatar:'/static/wx_avatar/7.jpg'},
        {id:8, wx_id:'wx_0fwaflemalej1', name:'知道狗长啥样', created_at:times[8].format(),avatar:'/static/wx_avatar/8.jpg'},
